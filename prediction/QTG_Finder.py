...
# Usage = "QTG_Finder.py feature_list QTL_gene_list species_abbreviation"
...
# Usage example: QTG_Finder.py Arabidopsis_features-v3.05.txt SSQ_batch_QTL_genes.csv 'AT'
